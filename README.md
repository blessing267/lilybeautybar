...
## 🚀 Features  
- 🛍️ **Product Catalogue** – Browse products with images, descriptions, prices and product details.
- 🛒 **Shopping Cart & Checkout** – Add products to a cart and complete the checkout process.
- 🔐 **Guest Checkout** – Customers can place orders without creating an account.
- 💳 **Paystack Payment Integration** – Secure online payment processing through Paystack.
- 📱 **Responsive Storefront** – Mobile-friendly interface built for different screen sizes.
- ⚛️ **React Admin Dashboard** – Custom dashboard for managing products, categories, customers, orders and other store content.
- 🔄 **REST API Integration** – React dashboard communicates with the Django backend through REST APIs using Axios.
- 🗄️ **PostgreSQL Database** – Persistent storage for application and e-commerce data.  
